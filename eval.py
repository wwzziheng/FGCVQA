...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_dir', type = str, required = False, default = "./save/imageclef20vqa_test_acc.pt", help = "path to load weights")
    parser.add_argument('--save_dir', type = str, required = False, default = "./save/eval_result", help = "path to save weights")
