...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_dir', type = str, required = False, default = "./save/roco_mlm/cro(20).pt", help = "path to load weights")
    ...
    parser.add_argument('--lr', type = float, required = False, default = 7e-5, help = "learning rate'")
    ...
    for epoch in range(args.epochs):
        ...
        if test_acc['total_acc'] > test_best_acc:
            ...
            torch.save(model.state_dict(), os.path.join(args.save_dir, f'test_acc_{epoch+1}.pt'))
