...
from BertCrossattlayer import FGCVQAModel,BertConfig, BertPooler, CMEncoder
...
class Transfer(nn.Module):
    ...
    def forward(self, img):
        ...
        v_2 = fix2(img)
        v_2 = self.conv2(v_2)
        v_2 = v_2.view(-1, self.args.hidden_size, 7*7).contiguous().transpose(1, 2)
        return v_2
...
class Transformer(nn.Module):
    ...
    def forward(self, img, input_ids, token_type_ids, mask):
        ...
        lang_feats, visn_feats = self.encoder(h, mask, v_2, None)
